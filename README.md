...
- Editor "paint" per creare design da zero con palette colore.
- Rendering realistico delle perline con effetto bead.
- Condivisione design via URL (hash con stato serializzato).
- Tema cottagecore (scrivania/tavolo in legno) + cursore a forma di zampa di gatto.
